    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown {{(request()->is('sales*')) ? 'active' :''}}">
                ...
                <ul class="dropdown-menu">
                    @can('create',\App\Sale::class)<li><a class="nav-link" href="{{Route('sales.newSalesOrder')}}">New Sales Order</a></li>@endcan
                    @can('create',\App\Sale::class)<li><a class="nav-link" href="{{Route('sales.createNewSalesQuotation')}}">New Sales Quotation</a></li>@endcan
                    @can('create',\App\Sale::class)<li><a class="nav-link" href="{{Route('sales.customerCreate')}}">Register New Customer</a></li>@endcan
                    @can('read',\App\Sale::class)<li><a class="nav-link" href="{{Route('sales.customerOverview')}}">Customer overview</a></li>@endcan
                </ul>
            </li>
            ...
            <li class="nav-item dropdown {{(request()->is('supplier*')) ? 'active' :''}}">
                ...
                <ul class="dropdown-menu">
                    @can('read',\App\Supplier::class)<li><a class="nav-link" href="{{Route('supplier.overview')}}">Overview</a></li>@endcan
                    @can('create',\App\Supplier::class)<li><a class="nav-link" href="{{Route('supplier.create')}}">New Supplier</a></li>@endcan
{{--                    @can('create',Auth::user())<li><a class="nav-link" href="{{Route('supplier.assignItems')}}">Assign Items</a></li>@endcan--}}
            ...
            <li class="nav-item dropdown {{(request()->is('product*')) ? 'active' :''}}">
                ...
                <ul class="dropdown-menu">
                    @can('read',\App\Product::class)<li><a class="nav-link" href="{{Route('product.overview')}}">Overview</a></li>@endcan
                    @can('create',\App\Product::class)<li><a class="nav-link" href="{{Route('product.create')}}">Add New Product</a></li>@endcan
{{--                    @can('read',Auth::user())<li><a class="nav-link" href="{{Route('product.warrantyManagementOverview')}}">Manage Warranties</a></li>@endcan--}}
            ...
            <li class="nav-item dropdown {{(request()->is('purchase*')) ? 'active' :''}}">
                ...
                <ul class="dropdown-menu">
                    @can('create',\App\Purchase::class)<li><a class="nav-link" href="{{Route('purchase.create')}}">New Purchase Order</a></li>@endcan
                    @can('create',\App\Purchase::class)<li><a class="nav-link" href="{{Route('purchase.GRNCreate')}}">Insert New GRN</a></li>@endcan
                </ul>
            </li>

            <li class="nav-item dropdown {{(request()->is('reports*')) ? 'active' :''}}">
                @can('create',\App\Report::class)<a href="{{Route('reports.overview')}}" class="nav-link "><i class="fas fa-file-contract"></i><span>Reports</span></a>@endcan
            </li>
