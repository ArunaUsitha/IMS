...
{{--{{ Auth::user()->unreadNotifications->count() ? ' beep' : '' }}--}}
...
{{--        @endif--}}
  ...
  <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
    <img alt="image" src="{{url((Auth::user()->profile_img) !== null ? "/images/".Auth::user()->profile_img : "/images/default-avatar.jpg")}}" class="rounded-circle mr-1">
